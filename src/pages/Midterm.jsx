  ...
  const sections = [
    {
      ...
      items: [
        { 
          ...
          document: `${import.meta.env.BASE_URL}reflections/Quiz1.txt`
        },
      ]
    },
    {
      ...
      items: [
        { 
          ...
          document: `${import.meta.env.BASE_URL}reflections/Seatwork1.txt` 
        },
        { 
          name: "Midterm Seatwork 2: Coding in Paper", 
          date: "Mar 01, 2026", 
          image: "https://placehold.co/600x400/10b981/white?text=Seatwork+2",
          document: `${import.meta.env.BASE_URL}reflections/Seatwork2.txt` 
        },
      ]
    },
    {
      ...
      items: [
        { 
          ...
          date: "Mar 01, 2026", 
          image: `${import.meta.env.BASE_URL}images/MidtermAssignment1.jpg`
        },
        { 
          name: "Midterm Activity 1: Variables", 
          date: "Mar 05, 2026", 
          image: `${import.meta.env.BASE_URL}images/MidtermActivity1.jpg`,
          ...
          document: `${import.meta.env.BASE_URL}docs/MidtermAvtivity1Variables.pdf`
        },
        { 
          name: "Midterm Activity 2: Operators", 
          date: "Mar 03, 2026", 
          image: [
            `${import.meta.env.BASE_URL}images/MidtermAcitivity2.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermAcitivity2-2.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermAcitivity2-3.jpg`
          ],
        ...
        { 
          ...
          date: "Mar 27, 2026", 
          image: [
            `${import.meta.env.BASE_URL}images/MidtermActivity3.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermActivity3-2.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermActivity3-3.jpg`
          ],
          ...
          sourceCode: `${import.meta.env.BASE_URL}code/MidtermActivity3.java`
        },
        { 
          name: "Midterm Activity 4: Student Payment System with Validation Counter", 
          date: "Mar 27, 2026", 
          image: [
            `${import.meta.env.BASE_URL}images/MidtermActivity4.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermActivity4-2.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermActivity4-3.jpg`
          ],
          ...
          sourceCode: `${import.meta.env.BASE_URL}code/MidtermAvtivity4.java`
        },
        { 
          name: "Midterm Activity 5: Personal Expense Tracker", 
          date: "Apr 12, 2026", 
          image: [
            `${import.meta.env.BASE_URL}images/MidtermActivity5.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermActivity5-2.jpg`,
            `${import.meta.env.BASE_URL}images/MidtermActivity5-3.jpg`
          ],
    ...
    },
    {
      ...
      items: [
        { 
          ...
          document: `${import.meta.env.BASE_URL}reflections/MidtermExam.txt`
        },
      ]
    }
  ];
